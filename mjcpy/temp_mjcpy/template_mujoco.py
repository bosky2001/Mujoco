...
contact_y = []
contact_z = []
#mj.mjd_transitionFD(model, data , 1e-6, True, A, B, None, None)
#print(A)
while not glfw.window_should_close(window):
    ...
    for j,c in enumerate(data.contact):
        ...
        contact_x.append(forcetorque[0])
        contact_y.append(forcetorque[1])
        contact_z.append(forcetorque[2])
